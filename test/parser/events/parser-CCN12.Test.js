...
describe('Parser', function() {
    before(function() {
        this.server = require('../../../libs/server')('testEventCCN12');
        this.stream = require('fs').createReadStream(path.join('test', 'acData', 'inputstreamCCN12'));
    });
    // after(function() {});
    // beforeEach(function() {});
    // afterEach(function() {});
    ...
    describe('inputstreamCCN12', function() {
